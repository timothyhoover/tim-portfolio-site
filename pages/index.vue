...
main(class='flex justify-center md:justify-start w-full h-full')
  section(class='flex justify-center items-center flex-col w-full h-full md:items-start md:justify-center md:w-8/12 xl:w-9/12')
    ...
    p(class='text-lg w-10/12')
      ...
      | web solutions for their portfolios. Most recently I’ve been developing learning applications
      | and interactive environments for Topic Talk Inglés and have found a passion for e-learning.
      br
      br
      | I’ve also had experience with many facets in management, including project and team management
      | and client communications. In my spare time, you can catch me playing guitar, traveling, and learning
