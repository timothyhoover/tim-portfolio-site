  ...
  header(:class='!menu.mobileMenu ? "-translate-x-full" : ""' class='shadow-md w-64 space-y-6 py-7 absolute inset-y-0 left-0 transform bg-white md:relative md:translate-x-0 transition duration-200 ease-in-out z-50')
    ...
    nav(class="flex flex-col items-center w-full pt-2")
      div(class="flex flex-col items-center text-xs md:text-sm font-semibold w-full")
        nuxt-link(to="/" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
        ...
        nuxt-link(to="/experience" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
            path(fill-rule='evenodd', d='M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414l-4.293 4.293a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0L11 10.586 14.586 7H12z', clip-rule='evenodd')
          span(class="self-end") Experience
        nuxt-link(to="/projects" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
            path(d='M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z')
          span(class="self-end") Projects
        nuxt-link(to="/skills" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
            path(fill-rule='evenodd', d='M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z', clip-rule='evenodd')
          span(class="self-end") Skills
        nuxt-link(to="/testimonials" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
            path(fill-rule='evenodd', d='M18 3a1 1 0 00-1.447-.894L8.763 6H5a3 3 0 000 6h.28l1.771 5.316A1 1 0 008 18h1a1 1 0 001-1v-4.382l6.553 3.276A1 1 0 0018 15V3z', clip-rule='evenodd')
          span(class="self-end") Testimonials
        nuxt-link(to="/education" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
        ...
        nuxt-link(to="/resume" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
            path(fill-rule='evenodd', d='M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z', clip-rule='evenodd')
          span(class="self-end") Resume
        nuxt-link(to="/contact" @click='menu.mobileMenu = false' active-class="border-l-4 border-tim-blue bg-gray-100" class="nav-link")
          svg(xmlns='http://www.w3.org/2000/svg', class='h-[30px] w-[30px]', viewBox='0 0 20 20', fill='currentColor')
